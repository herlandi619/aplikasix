...
@section('container')
    ...
    <div class="d-flex justify-content-end my-2">
        <a href="/dashboard/posts/create" class="btn btn-secondary">Create Post</a>
    </div>
        ...
        <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/posts/{{ $item->slug }}" class="btn btn-primary">Show</a>

                            <a href="/dashboard/posts/{{ $item->slug }}/edit" class="btn btn-success">Edit</a>
